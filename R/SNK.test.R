...
#' 
#' if y = model, then to apply the instruction:\cr SNK.test (model, "trt",
...
#' parameters} \item{snk}{Critical Range Table} \item{means}{Statistical
...
#' \code{\link{REGW.test}}, \code{\link{scheffe.test}},
