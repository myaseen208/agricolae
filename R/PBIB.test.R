...
#' 
#' Analysis of variance PBIB and comparison mean adjusted.  Applied to
#' resoluble designs: Lattices and alpha design.
#' 
#' Method of comparison treatment.  lsd: least significant difference. tukey:
#' Honestly significant difference. Estimate: specifies the estimation method
#' for the covariance parameters. The REML is the default method. The REML
#' specification performs residual (restricted) maximum likelihood, and The ML
#' specification performs maximum likelihood, and the VC specifications apply
#' only to variance component models.
#' 
#' @param block blocks
#' @param trt Treatment
...
#' @return \item{ANOVA}{Analysis of variance } \item{method}{Estimation method:
#' REML, ML and VC} \item{parameters}{Design parameters}
#' \item{statistics}{Statistics of the model} \item{model}{Object: estimation
#' model } \item{Fstat}{Criterion AIC and BIC} \item{comparison}{Comparison
#' between treatments} \item{means}{Statistical summary of the study variable}
...
#' \code{\link{LSD.test}}, \code{\link{Median.test}}, \code{\link{REGW.test}},
#' \code{\link{scheffe.test}}, \code{\link{SNK.test}},
#' \code{\link{waerden.test}}, \code{\link{waller.test}},
#' \code{\link{plot.group}}
#' @references 1. Iterative Analysis of Generalizad Lattice Designs.  E.R.
#' Williams (1977) Austral J. Statistics 19(1) 39-42.
#' 
#' 2. Experimental design. Cochran and Cox. Second edition.  Wiley Classics
#' Library Edition published 1992
#' @keywords models
#' 
#' @importFrom stats formula sd anova vcov AIC BIC pt ptukey
#' @export
#' @examples
#' 
#' require(agricolae)
