...
#' 
#' It makes multiple comparisons of treatments by means of Tukey.  The level by
#' alpha default is 0.05.
#' 
#' It is necessary first makes a analysis of variance.\cr
#' 
#' if y = model, then to apply the instruction:\cr HSD.test (model, "trt",
#' alpha = 0.05, group = TRUE, main = NULL, unbalanced=FALSE, console=FALSE)\cr
...
#' @param main Title
#' @param unbalanced TRUE or FALSE. not equal replication
...
#' \code{\link{friedman}}, \code{\link{kruskal}}, \code{\link{LSD.test}},
